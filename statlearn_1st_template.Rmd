...
The main diffult might be the condution of the experiments in the same fixed conditions.

*Approximatively, how "heavy" do you think your dataset will be in the end?*
The dataset will be aproximally around 500 units of instaces.
...
*Are you also planning to use or develop [dedicated hardware](https://sciencejournal.withgoogle.com/developers/) for this task?*
   The main hardware used is our smartphone to record experiments.
   NO dedicated hardware to build.
